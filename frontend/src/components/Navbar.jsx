...
export default function Navbar() {
  ...
  const navLinks = [
    { name: "Explore", href: "#" },
    { name: "Safari Lodges", href: "#" },
    { name: "Beach Escapes", href: "#" },
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#FAF6EF] border-b border-[#E8D9B8] px-4 md:px-10 flex items-center justify-between h-[68px]">
      ...
      <div className="hidden md:flex items-center gap-2">
        <button className="border border-[#3D2B1A] px-5 py-2 rounded-full text-[14px]">
          Sign In
        </button>
        <button className="bg-[#C4622D] text-white px-5 py-2 rounded-full text-[14px]">
          Get Started
        </button>
      </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-[68px] left-0 w-full bg-[#FAF6EF] overflow-hidden transition-all duration-300 ${
      ...
      >
        ...
        <div className="flex flex-col gap-2 px-4 mt-4">
          <button className="border border-[#3D2B1A] py-2 rounded-full text-[14px]">
            Sign In
          </button>
          <button className="bg-[#C4622D] text-white py-2 rounded-full text-[14px]">
            Get Started
          </button>
        </div>
      </div>
